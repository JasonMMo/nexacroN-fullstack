 ...
 * 		<a href="https://dev.mysql.com/doc/connector-j/8.1/en/connector-j-reference-type-conversions.html">connector-j type conversions</a>
...
public class Mysql extends AbstractDbms {
    ...
    public void handleColumnDataType(final DbColumn column) {
        ...
        if ("MEDIUMINT".equals(column.getVendorsTypeName())) {
            ...
            column.setDataType(PlatformDataType.INT);
        } else if ("INTEGER".equals(column.getVendorsTypeName())) {
            column.setDataType(PlatformDataType.INT);
        } else if ("INTEGER UNSIGNED".equals(column.getVendorsTypeName())) {
            column.setDataType(PlatformDataType.LONG);
        } else if ("BIGINT".equals(column.getVendorsTypeName())) {
            column.setDataType(PlatformDataType.LONG);
        } else if ("BIGINT UNSIGNED".equals(column.getVendorsTypeName())) {
