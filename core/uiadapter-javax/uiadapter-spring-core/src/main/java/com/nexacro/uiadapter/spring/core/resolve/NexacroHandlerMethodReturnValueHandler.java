 ...
 * @version 1.0
 * @see NexacroResult
 * @see NexacroFileResult
 * @see PlatformData
 */
public class NexacroHandlerMethodReturnValueHandler implements HandlerMethodReturnValueHandler {

    private final Logger logger = LoggerFactory.getLogger(NexacroHandlerMethodReturnValueHandler.class);
    ...
    public boolean supportsReturnType(MethodParameter returnType) {
        ...
        if(NexacroResult.class.isAssignableFrom(parameterType)) {
            ...
            return true;
        } else return NexacroFileResult.class.isAssignableFrom(parameterType);
    }
    ...
    public void handleReturnValue(Object returnValue, MethodParameter returnType, ModelAndViewContainer mavContainer,
        ...
        try {
            ...
            logger.error("Error handling return value. value{}, e={}, message={}", returnValue, e, e.getMessage(), e);
            throw e;
        } finally {
            sw.stop();
        ...
        for(String name: dataSetKeySet) {
            ...
            if(object == null) {
	            ...
	            if(dataSetConverter == null) {
	                logger.debug("Converter is not founded for setting from {} to DataSet({})", object.getClass(), name);
	                continue;
	            }
     ...
     * @param nexacroResult NexacroResult
     */
