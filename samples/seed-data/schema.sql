...
--    4. LARGE_DATA     — paging + streaming demo (10k rows after seed)
...
CREATE TABLE SAMPLE_BOARD (
    BOARD_ID       INTEGER      NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE DEPT (
    ...
    PARENT_ID      VARCHAR(20),                            -- NULL for roots
    SORT_ORDER     INTEGER      NOT NULL DEFAULT 0,
    LEVEL_NO       INTEGER      NOT NULL DEFAULT 1,        -- 1 = root
    ENABLED        BOOLEAN      NOT NULL DEFAULT TRUE,
...
CREATE TABLE LARGE_DATA (
    ...
    CATEGORY       VARCHAR(10)  NOT NULL,                  -- A..J for partition demo
...
CREATE TABLE FILE_META (
    FILE_ID        VARCHAR(40)  NOT NULL PRIMARY KEY,      -- UUID
