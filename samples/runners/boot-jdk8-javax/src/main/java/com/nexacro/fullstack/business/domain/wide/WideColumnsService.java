 ...
 *
 * Ported from <mvc-jdk8-javax-legacy>/<UidapterManyColumnServiceImpl.java>@69cdaf1a9d on 2026-04-24.
 * Adaptations: javax.servlet imports, JDK 8 syntax (no var/records/text-blocks), Spring Boot 2.7 compatibility.
 * Returns NexacroDataset (id="output1") instead of raw List wrapped in legacy NexacroResult;
 * column definitions align with WIDE_COLUMNS seed schema (50 cols).
 */
@Service
public class WideColumnsService {
     ...
     * JDK 8: new ArrayList<>() (diamond ok in JDK 7+); List.of() replaced with Collections.emptyList().
     */
