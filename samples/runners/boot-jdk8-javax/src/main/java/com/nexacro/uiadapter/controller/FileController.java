...
public class FileController {
    ...
    public NexacroResult upload(
        ...
        String uploader = (uploadedBy == null || uploadedBy.trim().isEmpty()) ? "anonymous" : uploadedBy;
    ...
    public void downloadList(
            ...
            HttpServletResponse response) throws IOException {
        List<String> ids = (fileIdsCsv == null || fileIdsCsv.trim().isEmpty())
                ? java.util.Collections.<String>emptyList()
                : java.util.Arrays.asList(fileIdsCsv.split("\\s*,\\s*"));
